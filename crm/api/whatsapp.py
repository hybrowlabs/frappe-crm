...
def is_whatsapp_enabled():
    ...
    try:
        ...
        # The WhatsApp Settings DocType metadata can linger after the app that
        # provides its controller is uninstalled. get_cached_value then fails to
        # import the controller — treat that as "not enabled" instead of a 500.
        return False
